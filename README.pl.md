...
| 003 | Depth Map Viewer | Kolorowa wizualizacja dysparycji stereo pokazująca informację podobną do głębi w czasie rzeczywistym. | [EN](examples/002_depth_map_viewer/README.md) / [PL](examples/002_depth_map_viewer/README.pl.md) |
| 004 | RGB + Depth Split-Screen | Widok dzielony w czasie rzeczywistym porównujący zwykły obraz RGB z kolorową wizualizacją dysparycji stereo. | [EN](examples/003_rgb_depth_split_screen/README.md) / [PL](examples/003_rgb_depth_split_screen/README.pl.md) |
| 005 | Depth Proximity Alert | Interaktywne demo oparte na dysparycji, które reaguje, gdy obiekt zbliża się do środka obrazu z kamery. | [EN](examples/004_depth_proximity_alert/README.md) / [PL](examples/004_depth_proximity_alert/README.pl.md) |
| 006 | Depth Hot Zone Game | Mini-gra w czasie rzeczywistym, w której gracz zdobywa punkty, przesuwając rękę lub obiekt do strefy aktywnej opartej na dysparycji. | [EN](examples/005_depth_hot_zone_game/README.md) / [PL](examples/005_depth_hot_zone_game/README.pl.md) |
| 007 | Moving Depth Target Game | Mini-gra w czasie rzeczywistym, w której gracz zdobywa punkty, trafiając w losowo rozmieszczone strefy celu oparte na dysparycji. | [EN](examples/007_moving_depth_target_game/README.md) / [PL](examples/007_moving_depth_target_game/README.pl.md) |
